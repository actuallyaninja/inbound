...
static const GPathInfo FOUR_BOXY = {
  10,
  (GPoint[]) {{0,0},{10,0},{10,11},{17,11},{17,0},{25,0},{25,35},{17,35},{17,20},{0,20}}
};
...
static const GPathInfo SIX_BOXY = {
  12,
  (GPoint[]) {{0,0},{25,0},{25,8},{10,8},{10,27},{18,27},{18,21},{0,21},{0,14},{25,14},{25,35},{0,35}}
};

static const GPathInfo SEVEN_BOXY = {
  6,
  (GPoint[]) {{0,0},{25,0},{25,35},{16,35},{16,10},{0,10}}
};

static const GPathInfo EIGHT_BOXY = {
  14,
  (GPoint[]) {{0,15},{0,0},{25,0},{25,35},{0,35},{0,14},{25,14},{25,21},{10,21},{10,28},{18,28},{18,8},{10,8},{10,15}}
};

static const GPathInfo NINE_BOXY = {
  10,
  //(GPoint[]) {{0,0},{25,0},{25,35},{16,35},{16,8},{9,8},{9,14},{25,14},{25,21},{0,21}}
    (GPoint[]) {{0,0},{25,0},{25,35},{17,35},{17,8},{10,8},{10,14},{25,14},{25,21},{0,21}}
};
